...
var audioMixUtil = /** @class */ (function () {
    ...
    audioMixUtil.prototype.mixEffect = function (audioBuffer, callBack) {
        ...
        var ac = new (typeof webkitAudioContext !== 'undefined' ? webkitAudioContext : AudioContext)();
        this.streamSource = ac.createMediaStreamSource(this.localStream);
        this.gainNode = ac.createGain();
        this.destination = ac.createMediaStreamDestination();
        this.buffSource = ac.createBufferSource();
        ...
        if (!sender) {
            this.logger.error("amu.me.0 no sender");
            return false;
        }
        ...
        this.logger.info('amu.me.0 mix effect success');
        callBack();
    };
    //开始混音
    audioMixUtil.prototype.startMixingAudio = function (audio) {
        if (this.isMixAudio) {
        ...
        this.gainNode = ac.createGain();
        this.destination = ac.createMediaStreamDestination();
        this.mixAudio = ac.createMediaStreamSource(audio.captureStream());
        this.streamSource.connect(this.destination);
        ...
        var sender = this.peerConnection.getSenders().find(function (s) { return s.track.kind === audioTrack.kind; });
        if (!sender) {
            this.logger.error("amu.sma.0 no sender");
            return false;
        }
        this.micTrack = this.localStream.getAudioTracks()[0];
        sender.replaceTrack(audioTrack);
        ...
        this.localStream.addTrack(audioTrack);
        this.isMixAudio = true;
        this.logger.info("amu.sma.0 mix audio success");
        return true;
    };
...
var MediaRecoder_1 = __webpack_require__(/*! ../../types/MediaRecoder */ "./types/MediaRecoder.ts");
var ZegoClient = /** @class */ (function (_super) {
    ...
    */
    ...
    //开始混音
    ZegoClient.prototype.startMixingAudio = function (streamid, audio) {
        this.logger.debug("zc.sma.0 call");
        if (!streamid) {
            this.logger.error("zc.sma.0 no streamid");
            return false;
        }
        if (!audio) {
        ...
        return publisher.startMixingAudio(audio);
    };
    //停止混音
    ...
    ZegoClient.startRecord = function (el) {
        ...
        if (!MediaRecoder_1.MediaRecorder.isTypeSupported(options.mimeType)) {
        ...
        try {
            ZegoClient.mediaRecorder = new MediaRecoder_1.MediaRecorder(playStream, options);
        }
        catch (e) {
...
var ZegoPublish = /** @class */ (function () {
   ...
   */
    ...
    */
    ...
    ZegoPublish.prototype.startMixingAudio = function (audio) {
        this.audioMixing.localStream = this.localStream;
        this.audioMixing.peerConnection = this.peerConnection;
        return this.audioMixing.startMixingAudio(audio);
    };
